...
@EnableRedisRepositories(basePackages = ["io.vertex.sample.data.simplex"])
class SampleDataSimplexApplication(private val vertx: Vertx) {
	companion object {
		val logger: Logger = LoggerFactory.getLogger(SampleDataSimplexApplication::class.java)
	}
...
fun main(args: Array<String>) {
	runApplication<SampleDataSimplexApplication>(*args)
}
